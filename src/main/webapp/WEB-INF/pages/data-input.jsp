            ...
            <center>
                ...
                <table id="post" class="input">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>Comments<p><form:textarea path="comment" style="height: 30px; width: 400px; background-color: white" placeholder="Enter Comments Here" maxlength="255"></form:textarea></th>
